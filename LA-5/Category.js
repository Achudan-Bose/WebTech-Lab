...
const Category = (props) => {
 const underlineStyle = 'before:block before:rounded-tl-md before:rounded-tr-md before:absolute 
before:w-[90px] before:h-1 before:left-1/2 before:bottom-0 before:-translate-x-1/2 before:bg-
[#2F80ED]';
 return (
